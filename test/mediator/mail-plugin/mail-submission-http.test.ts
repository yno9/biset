...
import { createMailSubmissionHttpHandler } from '../../../src/server/mediator/mail-plugin/mail-submission-http.ts'
import { encodeMailSubmissionRequestWire } from '../../../src/server/mediator/mail-plugin/mail-submission-wire.ts'
...
import type { MailDeliveryResult } from '../../../src/server/mediator/mail-plugin/smtp-client.ts'
