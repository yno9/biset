...
} from '../../../src/server/mediator/mail-plugin/mail-smtp-protocol.ts'
import type { AcceptIngressInput, SmtpEffect, SmtpRecipientResolution, SmtpSessionDeps } from '../../../src/server/mediator/mail-plugin/mail-smtp-protocol.ts'
