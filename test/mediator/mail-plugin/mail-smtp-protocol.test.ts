...
} from '../../../src/server/mail-plugin/mail-smtp-protocol.ts'
import type { AcceptIngressInput, SmtpEffect, SmtpRecipientResolution, SmtpSessionDeps } from '../../../src/server/mail-plugin/mail-smtp-protocol.ts'
