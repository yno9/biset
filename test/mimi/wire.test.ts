...
import type { RoomState, UpdateRoomRequest, VisibleCredential } from '../../src/protocol/mimi/protocol-types.ts'
...
describe('MIMI JSON/base64url wire', () => {
  ...
  test('round-trips a PseudonymousCredential without a real user URI', () => {
    const credential = { kind: 'pseudonymous' as const, clientPseudonym: 'mimi://provider.test/u/client', userPseudonym: 'mimi://provider.test/u/user', signaturePublicKey: new Uint8Array([1]), identityLinkCiphertext: new Uint8Array([2, 3]) }
