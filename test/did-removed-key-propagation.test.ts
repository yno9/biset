// The bug: didcomm-devices.ts's removeDeviceKey deletes a sibling kid from
...
import { buildBisetDocument, type DidDocument } from '../src/did/dht/document.ts'
import { buildSignedPayload } from '../src/did/dht/packet.ts'
import { didFromRootPublicKey } from '../src/did/dht/identifier.ts'
import { syncDevicePosition } from '../src/did/didcomm-devices.ts'
import type { DidRecord } from '../src/did/store.ts'
import { useSeqStore } from '../src/did/dht/freshness.ts'
