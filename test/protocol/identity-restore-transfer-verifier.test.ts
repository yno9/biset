...
import { createMlsGroup, generateOwnKeyPackage, memberKids } from '../../src/client/mls/group.ts'
import { mlsDeviceFixture } from './support/mls-device-fixture.ts'
import { MlsMembershipSegmentKeyWrapSigner } from '../../src/client/mls/segment-key-membership.ts'
...
describe('buildRestoreTransferVerifier', () => {
  test('accepts an event and a SegmentKeyWrap from a real current self-group member', async () => {
    ...
    const { epochOf } = await import('../../src/client/mls/group.ts')
