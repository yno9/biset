// Outbound SMTP client (PLAN_biset-mail-mediator.md section 12). Delivers a
// message to arbitrary remote MX servers -- the client-side mirror of
// smtp-listener.ts. Copied verbatim from
// src/core/adapters/mail-smtp-client.ts: this file already had zero
// dependency on biset-core's vault/identity/JMAP layers (its own original
// header comment said so), so moving it here needed no changes at all.
