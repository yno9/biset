 ...
 * `code` alongside the human text -- a caller that must branch on the
 * reason (e.g. treat a full mediator queue differently from an unenrolled
 * kid) needs the code, not a string it has to re-parse. */
