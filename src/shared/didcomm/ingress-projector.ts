...
import type { LocalJmapProjectionV1, LocalJmapSnapshot } from '../../client/store/projection/gateway.ts'
...
import type { IngressVerifierProjector } from '../../client/store/vault/ingress-ingest.ts'
import { decryptVaultObject } from '../../client/store/vault/objects.ts'
import { buildVaultMutation } from '../../client/store/vault/mutations.ts'
...
import type { VaultDeliveryOutboxRecord, VaultEventRecord, VaultObjectRecord } from '../../client/store/vault/store.ts'
