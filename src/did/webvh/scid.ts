// SCID (Self-Certifying IDentifier) generation and verification
// (DIDWEBVHFEAT.md §3, did:webvh v1.0 spec "SCID Generation and
// Verification"). The SCID is the hash of the genesis log entry with a
// `{SCID}` placeholder standing in for itself everywhere it would otherwise
// appear — which is exactly why it can't be re-derived from the root key
// alone (PLANWEBVH.md §2.1): the hash depends on the whole preliminary
// document, not just a public key.
