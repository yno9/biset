...
// remote MX servers -- the client-side mirror of this directory's own
// listener.ts (inbound). Moved here 2026-09-04 from src/core/adapters/
// (retired with biset-core) -- purely generic Bun.connect/node:dns logic,
// no core-specific dependency, so nothing but the location changed.
